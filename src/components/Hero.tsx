            ...
            <div className="relative z-10 max-w-[900px] w-full mx-auto px-6 text-center flex flex-col items-center">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center gap-4 mb-16">
                        ...
                        <a href="https://maps.app.goo.gl/7X3iUE6ANTpU9gym7" target="_blank" rel="noopener noreferrer" className="border border-gold text-gold px-8 py-4 font-sans text-sm font-semibold uppercase tracking-widest rounded-none hover:bg-gold hover:text-darker transition-all duration-300 w-full sm:w-auto">
                            Store Location
                        </a>
                    </motion.div>
